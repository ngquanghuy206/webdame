...
DAME_SLOT_PLANS = [
    # === THEO NGÀY ===
    {"id":"sl_1x1d",  "name":"1 Slot Dame · 1 ngày",    "slots":1,  "days":1,   "price":30000,  "popular":False},
    {"id":"sl_1x3d",  "name":"1 Slot Dame · 3 ngày",    "slots":1,  "days":3,   "price":60000,  "popular":False},
    {"id":"sl_1x7d",  "name":"1 Slot Dame · 7 ngày",    "slots":1,  "days":7,   "price":99000,  "popular":False},
    {"id":"sl_3x1d",  "name":"3 Slot Dame · 1 ngày",    "slots":3,  "days":1,   "price":75000,  "popular":False},
    {"id":"sl_3x3d",  "name":"3 Slot Dame · 3 ngày",    "slots":3,  "days":3,   "price":149000, "popular":True},
    {"id":"sl_3x7d",  "name":"3 Slot Dame · 7 ngày",    "slots":3,  "days":7,   "price":249000, "popular":False},
    {"id":"sl_5x1d",  "name":"5 Slot Dame · 1 ngày",    "slots":5,  "days":1,   "price":99000,  "popular":False},
    {"id":"sl_5x3d",  "name":"5 Slot Dame · 3 ngày",    "slots":5,  "days":3,   "price":219000, "popular":False},
    {"id":"sl_5x7d",  "name":"5 Slot Dame · 7 ngày",    "slots":5,  "days":7,   "price":349000, "popular":False},
    {"id":"sl_10x1d", "name":"10 Slot Dame · 1 ngày",   "slots":10, "days":1,   "price":149000, "popular":False},
    {"id":"sl_10x3d", "name":"10 Slot Dame · 3 ngày",   "slots":10, "days":3,   "price":329000, "popular":True},
    {"id":"sl_10x7d", "name":"10 Slot Dame · 7 ngày",   "slots":10, "days":7,   "price":499000, "popular":False},
    # === THEO TUẦN ===
    {"id":"sl_1x1w",  "name":"1 Slot Dame · 1 tuần",    "slots":1,  "days":7,   "price":99000,  "popular":False},
    {"id":"sl_1x2w",  "name":"1 Slot Dame · 2 tuần",    "slots":1,  "days":14,  "price":169000, "popular":False},
    {"id":"sl_3x1w",  "name":"3 Slot Dame · 1 tuần",    "slots":3,  "days":7,   "price":250000, "popular":True},
    {"id":"sl_3x2w",  "name":"3 Slot Dame · 2 tuần",    "slots":3,  "days":14,  "price":399000, "popular":False},
    {"id":"sl_5x1w",  "name":"5 Slot Dame · 1 tuần",    "slots":5,  "days":7,   "price":380000, "popular":False},
    {"id":"sl_5x2w",  "name":"5 Slot Dame · 2 tuần",    "slots":5,  "days":14,  "price":599000, "popular":False},
    {"id":"sl_10x1w", "name":"10 Slot Dame · 1 tuần",   "slots":10, "days":7,   "price":649000, "popular":True},
    {"id":"sl_10x2w", "name":"10 Slot Dame · 2 tuần",   "slots":10, "days":14,  "price":999000, "popular":False},
    {"id":"sl_20x1w", "name":"20 Slot Dame · 1 tuần",   "slots":20, "days":7,   "price":1099000,"popular":False},
    # === THEO THÁNG ===
    {"id":"sl_1x1m",  "name":"1 Slot Dame · 1 tháng",   "slots":1,  "days":30,  "price":350000, "popular":True},
    {"id":"sl_1x3m",  "name":"1 Slot Dame · 3 tháng",   "slots":1,  "days":90,  "price":799000, "popular":False},
    {"id":"sl_1x6m",  "name":"1 Slot Dame · 6 tháng",   "slots":1,  "days":180, "price":1399000,"popular":False},
    {"id":"sl_3x1m",  "name":"3 Slot Dame · 1 tháng",   "slots":3,  "days":30,  "price":950000, "popular":True},
    {"id":"sl_3x3m",  "name":"3 Slot Dame · 3 tháng",   "slots":3,  "days":90,  "price":1999000,"popular":False},
    {"id":"sl_5x1m",  "name":"5 Slot Dame · 1 tháng",   "slots":5,  "days":30,  "price":1499000,"popular":False},
    {"id":"sl_5x3m",  "name":"5 Slot Dame · 3 tháng",   "slots":5,  "days":90,  "price":2999000,"popular":False},
    {"id":"sl_10x1m", "name":"10 Slot Dame · 1 tháng",  "slots":10, "days":30,  "price":2599000,"popular":True},
    {"id":"sl_10x3m", "name":"10 Slot Dame · 3 tháng",  "slots":10, "days":90,  "price":4999000,"popular":False},
    {"id":"sl_20x1m", "name":"20 Slot Dame · 1 tháng",  "slots":20, "days":30,  "price":3999000,"popular":False},
    # === THEO NĂM ===
    {"id":"sl_1x1y",  "name":"1 Slot Dame · 1 năm",     "slots":1,  "days":365, "price":3499000,"popular":True},
    {"id":"sl_3x1y",  "name":"3 Slot Dame · 1 năm",     "slots":3,  "days":365, "price":8999000,"popular":False},
    {"id":"sl_5x1y",  "name":"5 Slot Dame · 1 năm",     "slots":5,  "days":365, "price":12999000,"popular":False},
    # === COMBO ĐẶC BIỆT ===
    {"id":"sl_s1",    "name":"Starter · 2 Slot · 7 ngày",   "slots":2,  "days":7,   "price":149000, "popular":False},
    {"id":"sl_s2",    "name":"Growth · 2 Slot · 1 tháng",   "slots":2,  "days":30,  "price":599000, "popular":False},
    {"id":"sl_s3",    "name":"Pro · 5 Slot · 2 tuần",       "slots":5,  "days":14,  "price":549000, "popular":True},
    {"id":"sl_s4",    "name":"Business · 5 Slot · 1 tháng", "slots":5,  "days":30,  "price":1299000,"popular":False},
    {"id":"sl_s5",    "name":"Elite · 10 Slot · 2 tuần",    "slots":10, "days":14,  "price":999000, "popular":False},
    {"id":"sl_s6",    "name":"Elite · 10 Slot · 3 tháng",   "slots":10, "days":90,  "price":4999000,"popular":False},
    {"id":"sl_s7",    "name":"Ultimate · 20 Slot · 1 tháng","slots":20, "days":30,  "price":3999000,"popular":True},
    {"id":"sl_s8",    "name":"Mega · 50 Slot · 1 tháng",    "slots":50, "days":30,  "price":7999000,"popular":False},
    {"id":"sl_free",  "name":"Free · 1 Slot · 3 ngày (TK mới)","slots":1,"days":3, "price":0,      "popular":False,"trial":True},
]
